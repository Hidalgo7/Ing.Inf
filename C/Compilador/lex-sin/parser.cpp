...
{
       0,    81,    81,    81,    93,   105,   113,   114,   117,   121,
     126,   130,   131,   135,   136,   139,   140,   143,   143,   147,
     148,   151,   151,   158,   159,   161,   162,   162,   169,   170,
     177,   183,   192,   191,   211,   221,   227,   232,   237,   247,
...
#line 305 "parser.y"
        {
        (yyval.expr) = new expresionstruct;
        codigo.anadirInstruccion("if" + (yyvsp[0].expr)->str + " = 0 goto");
	*(yyval.expr) = makearithmetic((yyvsp[-2].expr)->str,*(yyvsp[-1].str),(yyvsp[0].expr)->str) ;
	delete (yyvsp[-2].expr); delete (yyvsp[0].expr);
        }
